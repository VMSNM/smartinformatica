export const portfolioDemoLimitations = {
    msg: 'This is a demo account and has some limitations, mainly because of API credits requests. Regarding the Portfolios here are the most important limitations:',
    limitations: [
